...
static void CheckFirmwareFlag(void)
{
	...
	{				
		...
		{			
			...
			{
				{
					.eIndex = (ProgramInfoIndex)(g_sUpdateManager.u8FirmwareFlagAddr), 
					.u8Data = 0x1,
				},
			};
...
//	}
	...
	{
		{
			.eIndex = (ProgramInfoIndex)(g_sUpdateManager.u8UpdateIndex), 
...
FirmwareEvent cbRollbackCheck(void)
{
	...
	ReadSingleMemoryInfo(LAST_APP_INDEX, &u8Data);
...
//	}
	...
	{
		{
			.eIndex = (ProgramInfoIndex)u8CurrentIndex, 
			.u8Data = 0,
		},
...
bool UpdateProcessBusy(void)
{
	return g_sUpdateManager.bBusy;
}
